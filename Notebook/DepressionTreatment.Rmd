...
To assess depression severity, the author of the Dataset has used self reporting to gather severity of depression in 200 patients. The patients were male(95) and female(105) and fell between the ages of 18 to 40 years old. The patients were randomly assigned to participate in the traditional CBT method (Control group) or the VR-Based method (experimental.)

**Introduction**

**Hypothesis**:

In treatment of depression in men and women aged 10-40, a VR based method of treatment is more effective than traditional method.
