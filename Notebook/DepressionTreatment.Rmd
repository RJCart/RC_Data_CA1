...
ggplot(severity_table, aes(x = Severity, y = n, fill = Severity)) +
  geom_bar(stat = "identity", show.legend = FALSE) +
  labs(
    title = "Pre-Treatment Frequency of Depression Severity",
    x = "Severity Level",
    y = "Frequency"
  ) +
  theme_minimal()
...
ggplot(severity_table, aes(x = Severity, y = n, fill = Severity)) +
  geom_bar(stat = "identity", show.legend = FALSE) +
  labs(
    title = "Post-Treatment Frequency of Depression Severity",
    x = "Severity Level",
    y = "Frequency"
  ) +
  theme_minimal()
